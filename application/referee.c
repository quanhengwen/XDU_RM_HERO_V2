...
{
    *heat0_limit = robot_state.shooter_id2_17mm_cooling_limit;
    *heat0 = power_heat_data_t.shooter_id2_17mm_cooling_heat;
}

void get_shoot_heat1_limit_and_heat1(uint16_t *heat1_limit, uint16_t *heat1)
{
    *heat1_limit = robot_state.shooter_id1_42mm_cooling_limit;
	if( power_heat_data_t.shooter_id1_42mm_cooling_heat <= 500)
    *heat1 = power_heat_data_t.shooter_id1_42mm_cooling_heat;
}
