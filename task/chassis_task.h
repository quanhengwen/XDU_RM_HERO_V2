...
#define CHASSIS_VX_RC_SEN     0.008  //0.006f
//rocker value (max 660) change to horizontal speed (m/s)
//遥控器左右摇杆（max 660）转化成车体左右速度（m/s）的比例
#define CHASSIS_VY_RC_SEN     0.008        //0.005f
...
//底盘运动过程最大前进速度
#define BattDirect_NORMAL_MAX_CHASSIS_SPEED_X 3.0f
//chassis left or right max speed
//底盘运动过程最大平移速度
#define BattDirect_NORMAL_MAX_CHASSIS_SPEED_Y 3.0f


//超级电容供电模式下
//chassis forward or back max speed
//底盘运动过程最大前进速度
#define BuckBoost_NORMAL_MAX_CHASSIS_SPEED_X 4.0f
//chassis left or right max speed
//底盘运动过程最大平移速度
#define BuckBoost_NORMAL_MAX_CHASSIS_SPEED_Y 4.0f


//电源直供模式下小陀螺旋转速度(慢)
#define CHASSIS_ROTATE_SPEED_LOW  4.0f
//超级电容供电模式下小陀螺的旋转速度(快)
#define CHASSIS_ROTATE_SPEED_HIGH 8.0F
...
//摇摆过程底盘运动最大角度(rad)
#define SWING_MOVE_ANGLE 0.4//0.31415926535897932384626433832795f
...
#define M3505_MOTOR_SPEED_PID_MAX_IOUT 6000.0f
