...
void UART4_IRQHandler(void)
{
  ...
  /* USER CODE BEGIN UART4_IRQn 1 */
	if(__HAL_UART_GET_FLAG(CMS_Hub.huart,UART_FLAG_IDLE) != RESET)
	{
		__HAL_UART_CLEAR_IDLEFLAG(CMS_Hub.huart);											
		HAL_UART_AbortReceive(CMS_Hub.huart);
		uint16_t RX2_Length = REVE_BufLENGTH - hdma_uart4_rx.Instance->NDTR;
